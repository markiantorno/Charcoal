...
public class ObservationPairTest {
    ...
    public void setUp() throws Exception {
        ...
        Quantity goodQuantity = new Quantity().setCode(MMOLL_UNIT)
        ...
        QuantityDt goodQuantityDt = new QuantityDt().setCode(MMOLL_UNIT)
                .setValue(MMOLL_MEASURE);
    ...
    public void getValueQuantityDt() throws Exception {
        ...
        Assert.assertEquals(MMOLL_UNIT, quantity.getCode());
    }
